package com.nepalese.virgocomponent.manager;

import android.content.Context;
import android.view.animation.AnimationUtils;

import com.nepalese.virgocomponent.R;
import com.nepalese.virgocomponent.component.VirgoImageView;
    ...
    public static void setAnimation(VirgoImageView imageView, int animIn, int animOut){
        ...
        switch (animIn){
            case ANIM_TYPE_FADE_IN:
                imageView.setAnimationIN(AnimationUtils.loadAnimation(context, R.anim.fade_in));
                break;
