...
public class VirgoPickerView extends View {
    ...
    public VirgoPickerView(Context context, AttributeSet attrs) {
        ...
        loop = typedArray.getBoolean(R.styleable.VirgoPickerView_isLoop, true);
        mColorText = typedArray.getColor(R.styleable.VirgoPickerView_mainColor, 0x66ccff);
        nColorText = typedArray.getColor(R.styleable.VirgoPickerView_secondColor, 0x666666);
        init();
    }
