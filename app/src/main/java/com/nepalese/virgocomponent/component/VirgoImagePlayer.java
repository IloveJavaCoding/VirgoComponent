...
public class VirgoImagePlayer extends RelativeLayout {
    ...
    private List<ImageView> imageViewList; // 图库集
    private List<ImageView> dotList; // 点点集
    ...
    private void initStyle(AttributeSet attrs) {
        ...
        dotSize = typedArray.getDimensionPixelSize(R.styleable.VirgoImagePlayer_dotSize, 15);
        dotMargin = typedArray.getDimensionPixelSize(R.styleable.VirgoImagePlayer_dotMargin, 7);
        duration = typedArray.getInt(R.styleable.VirgoImagePlayer_duration, 10000);
        addDot = typedArray.getBoolean(R.styleable.VirgoImagePlayer_addDot, true);
        dotFocus = typedArray.getResourceId(R.styleable.VirgoImagePlayer_dotFocus, R.drawable.shape_dot_focus);
        dotUnFocus = typedArray.getResourceId(R.styleable.VirgoImagePlayer_dotUnFocus, R.drawable.shape_dot_unfocus);
        typedArray.recycle();
    }
    ...
    public static class VirgoPagerAdapter extends PagerAdapter {
        ...
        public VirgoPagerAdapter(List<ImageView> list) {
            this.list = list;
        }
    ...
    public void setImages(List<String> imgs){
        ...
        if(imgs.size()==1){
            ...
            Glide.with(context).load(imgs.get(0)).into(imageView);
            ...
            for(int i=0; i<imgs.size(); i++){
                ...
                Glide.with(context).load(imgs.get(i)).into(img);
